...
from Code.QT import Iconos, QTUtil
...
class Scanner(QtWidgets.QDialog):
    def __init__(self, owner, folder_scanners, desktop, geometry):
        ...
        self.setWindowFlags(
            QtCore.Qt.WindowType.WindowCloseButtonHint | QtCore.Qt.WindowType.FramelessWindowHint | QtCore.Qt.WindowType.WindowStaysOnTopHint)
    ...
    def save(self):
        ...
        self.selected_pixmap = selected_pixmap.scaled(
            256, 256, QtCore.Qt.AspectRatioMode.IgnoreAspectRatio, QtCore.Qt.TransformationMode.SmoothTransformation
        )
