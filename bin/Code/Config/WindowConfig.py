...
def options(parent, configuration):
    ...
    li = (
        ...
        (_("The text appears beside the icon"), QtCore.Qt.ToolButtonStyle.ToolButtonTextBesideIcon),
        (_("The text appears under the icon"), QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon),
    )
    ...
    if resultado:
        ...
        if por_defecto:
            li_asp1 = ("", 11, 11, False, 11, False, QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon, 14)
        else:
            del li_asp1[0]
        (
