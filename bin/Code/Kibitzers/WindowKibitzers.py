...
class WKibitzers(LCDialog.LCDialog):
    def __init__(self, w_parent, kibitzers_manager):
        ...
        p.setColor(QtGui.QPalette.Active, QtGui.QPalette.Highlight, QtCore.Qt.GlobalColor.darkCyan)
        p.setColor(QtGui.QPalette.Inactive, QtGui.QPalette.Highlight, QtCore.Qt.GlobalColor.cyan)
