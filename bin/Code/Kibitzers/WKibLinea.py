...
class WKibLinea(QtWidgets.QDialog):
    ...
    def __init__(self, cpu):
        ...
        self.flags = {
            True: QtCore.Qt.WindowType.Dialog | QtCore.Qt.WindowType.WindowTitleHint | QtCore.Qt.WindowType.WindowStaysOnTopHint,
            False: QtCore.Qt.WindowType.Dialog | QtCore.Qt.WindowType.FramelessWindowHint | QtCore.Qt.WindowType.WindowStaysOnTopHint,
        }
    ...
    def mover(self):
        ...
        self.setWindowFlags(QtCore.Qt.WindowType.WindowCloseButtonHint | self.flags[self.siMover])
        self.show()
        QTUtil.refresh_gui()
