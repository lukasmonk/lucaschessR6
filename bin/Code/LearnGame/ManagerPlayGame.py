...
class ManagerPlayGame(Manager.Manager):
    ...
    def start(self, recno, is_white, is_black, close_on_exit=False):
        ...
        # self.manager_analyzer = self.procesador.analyzer_clone()
        # self.manager_analyzer.options(self.min_mstime, 0, True)
        # self.manager_analyzer.maximize_multipv()
        ...
        self.show_rating_always, self.show_rating_different, self.show_rating_never = (
            None,
            True,
            False,
        )
        ...
        if self.book:
            ...
            if si_book_usu and si_book_obj:
                if jg_obj.movimiento() != jg_usu.movimiento():
                    ...
                    if self.show_rating in (
                        self.show_rating_always,
                        self.show_rating_different,
                    ):
