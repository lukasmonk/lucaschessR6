...
class WTournament(LCDialog.LCDialog):
    def __init__(self, w_parent, nombre_torneo):
        ...
        tb_en_a = Controles.TBrutina(self, li_acciones, icon_size=16, style=QtCore.Qt.ToolButtonStyle.ToolButtonTextBesideIcon)
        ...
        tb_en_g = Controles.TBrutina(self, li_acciones, icon_size=16, style=QtCore.Qt.ToolButtonStyle.ToolButtonTextBesideIcon)
        ...
        tb_en_gt = Controles.TBrutina(self, li_acciones, icon_size=16, style=QtCore.Qt.ToolButtonStyle.ToolButtonTextBesideIcon)
